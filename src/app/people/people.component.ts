...
export class PeopleComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var persona = this.people3.filter(persona => persona._id === this.id)

    if(persona.length>0){
      this.people[0]._id = persona[0]._id;
      this.people[0].name = persona[0].name;
      this.people[0].job = persona[0].job;
      this.people[0].birthdate = persona[0].birthdate;
      this.people[0].photo = persona[0].photo;
      this.people[0].bio = persona[0].bio;
    }
