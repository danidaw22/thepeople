...
export class CardComponent implements OnInit {
  ...
  loadData() {
    this.allPeople.push(
       ...
       "name": "Danielle Frye",
        "photo": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80",
        "birthdate": "2019-07-13T01:41:39-02:00",
        "job": "Programador",
        "id": "606d5fc21071e6e38e8ef840"
      },
      {
        ...
        "birthdate": "2014-02-16T07:00:22-01:00",
        "job": "Programador",
        "id": "606d5fc27f29b33cc9e233d7"
      },
      {
      ...
      },
      {
        ...
        "job": "Programador",
        "id": "606d5fc2b278be3fd63c7588"
      }
    )

    this.newArray = this.allPeople.map( people => {
       var fecha = moment(people.birthdate).format('MM/DD/YYYY');
